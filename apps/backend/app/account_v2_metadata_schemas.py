...
# Note: This module mirrors models/account_v2_metadata_schemas.py but lives at
# a flat import path (app.account_v2_metadata_schemas) to avoid Python's module-vs-package
# name conflict with the existing app.models module file.
...
class CardMetadata(BaseMetadata):
    ...
    settlement_account_ref: Optional[str] = Field(default=None)
